...
Если ни одного флага передано не было, то работа выполняется со всем проектом
...
| is_staff | является ли пользователь сотрудником (маркер для выделения сотрудников с ограниченными правами) | Bool | &#8212; | False |
| is_superuser | является ли пользователь суперюзером (маркер для системных суперпользователей с полным доступом) | Bool |&#8212; | False | 
| date_joined | дата последнего захода на сайт | DateTime | &#8212; | Now |
| profile_photo | аватар профиля | Image | &#8212; | &#8212; |
| level | уровень пользователя | Int | Значение неотрицательное | 1 |
| experience | опыт пользователя | Int | Значение неотрицательное | 0 |
...
| description | Описание курса | Text | длина не более 500 | null | 
...
| :------: | :--------: | :--------: | :---------: | :------------------: |
| course | ID курса | ForeignKey | &#8212; | &#8212; | 
| title | Название формы | Char | длина не более 255 | &#8212; |
| description | Описание формы | Char | длина не более 255 | &#8212; | 
| image | Изображение в форме | Image | &#8212; | &#8212; |


## Вопросы курса
| Название | Содержимое | Тип данных | Ограничения | Стандартное значение | 
| :------: | :--------: | :--------: | :---------: | :------------------: |
| form | ID формы | ForeignKey | &#8212; | &#8212; | 
| text | Текст вопроса | Char | длина не более 255 | &#8212; |
| image | Изображение, связанное с вопросом | Image | &#8212; | &#8212; |
...
| is_correct | Булево поле, которое указывает, является ли данный ответ правильным на соответствующий вопрос в тесте | Bool | &#8212; | &#8212; |
| image | Изображение, связанное с ответом | Image | &#8212; | &#8212; |
...
| created_at | Время получения уведомления | DateTime | &#8212; | Now |
